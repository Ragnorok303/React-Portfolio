        ...
        <nav className={navigationToggler ? "mi-header is-visible" : "mi-header"}>
            ...
            <div className="mi-header-inner">
                <div className="mi-header-image">
                    <Link to="/">
                        <img style={{height: '100%'}} src={information.brandImage} alt="brandimage"/>
                    </Link>
                </div>
                ...
                <p className="mi-header-copyright">&copy; {new Date().getFullYear()} <b><a rel="noopener noreferrer" target="_blank" href="https://nuclearthemes.com">Jason Tompkins</a></b></p>
            </div>
        </nav>
    )
}
